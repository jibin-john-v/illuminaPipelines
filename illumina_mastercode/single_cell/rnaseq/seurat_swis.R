...
sample_info <- read.csv("/Users/JJOHN41/Desktop/projects/test_data/single_cell_rnaseq/course_data/sample_info_course.csv")
datadirs <- file.path("/Users/JJOHN41/Desktop/projects/test_data/single_cell_rnaseq/course_data/", "count_matrices", sample_info$SampleName,
